...
```{r setup-tibble}
usernames <- c("wilsonamy", "ryxh7464", "username 2", "username 3", "username 4") #Extend if necessary
nums <- c(18, 8, NA, NA, NA) #Extend if necessary
colours <- c("powderblue", "pink", "colour 2", "colour 2", "colour 4") #Extend if necessary
hobbies <- c("Hiking", "drawing", "Hobby 2", "Hobby 3", "Hobby 4") #Extend if necessary
